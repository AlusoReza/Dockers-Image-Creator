...
:: Propósito: Levantar el contenedor y configurar permisos/base de datos.
:: =======================================================================================

title Lanzador de MySQL Docker

echo [1/2] Levantando contenedor MySQL...
:: Levanta los servicios definidos en el YAML. 
...
:: NOTA: Asegúrate de que "mysql-workbench-server" sea el 'container_name' en tu .yml
